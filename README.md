Glitch Wikipedia-scraping Twitter bot
===================================
...
The included code lists a wikipedia category, picks a random page, scrapes it for an image, and tweets it. Check out [the Twit module documentation](https://github.com/ttezel/twit) for more examples of what your bot can do.
